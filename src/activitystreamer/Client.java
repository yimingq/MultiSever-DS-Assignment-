...
public class Client {
    ...
    private static void help(Options options) {
        ...
        formatter.printHelp("ActivityStreamer.Client", header, options,
                footer, true);
        System.exit(-1);
    }
    ...
    public static void main(String[] args) {
        ...
        while (result == 0) {
            ...
            if (Settings.getUsername().equals("anonymous")
                    && Settings.getSecret() != null) {
                log.info("No username, the -s is meaningless,please restart");
                System.exit(0);
            }
        }
        ClientSkeleton c = ClientSkeleton.getInstance(result);
